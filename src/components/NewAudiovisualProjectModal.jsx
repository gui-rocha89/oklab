    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="lovable-modal-content fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[1001] bg-white rounded-2xl shadow-2xl w-full max-w-2xl flex flex-col"
