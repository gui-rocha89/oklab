  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <div className="modal-content-safe bg-white rounded-2xl shadow-2xl w-full max-w-4xl mx-4 my-8 flex flex-col" style={{ maxHeight: '90vh' }} role="dialog" aria-modal="true">
