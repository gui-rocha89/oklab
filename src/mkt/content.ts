...
export const features = [
  {
    id: 'video',
    title: 'Feedback preciso no frame',
    description: 'Marque o problema exato no momento certo do vídeo',
    image: '/mkt/feature-video.webp',
    bullets: [
      'Desenhe diretamente sobre o frame pausado',
      'Comentários ancorados ao timecode exato',
      'Timeline com marcações visuais de feedback',
      'Histórico completo de anotações por versão',
      'Player HTML5 otimizado para qualquer formato',
    ],
  },
  {
    id: 'briefings',
    title: 'Roteiros com contexto claro',
    description: 'Aprove conceitos e textos antes da produção',
    image: '/mkt/feature-briefings.webp',
    bullets: [
      'Comentários ancorados por parágrafo do roteiro',
      'Versionamento automático de cada revisão',
      'Aprovação em múltiplos estágios',
      'Referências visuais e anexos no mesmo doc',
      'Histórico de alterações transparente',
    ],
  },
  {
    id: 'social',
    title: 'Calendário visual de aprovação',
    description: 'Veja como o post ficará antes de publicar',
    image: '/mkt/feature-social.webp',
    bullets: [
      'Preview fiel de posts Instagram e Facebook',
      'Aprovação de copy, hashtags e arte em um clique',
      'Calendário editorial com status em tempo real',
      'Carrosséis com navegação entre imagens',
      'Export direto para publicação',
    ],
  },
];
